...
namespace GymManagement.DAL.Migrations
{
    ...
    [Migration("20260626023000_AddIdentityTables")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("GymManagement.DAL.Models.HelthRecord", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("GymManagement.DAL.Plan", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("GymManagement.DAL.Models.HelthRecord", b =>
                {
                    b.HasOne("GymManagement.DAL.Models.Member", "Member")
                        .WithOne("HelthRecord")
                        .HasForeignKey("GymManagement.DAL.Models.HelthRecord", "MemberId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("GymManagement.DAL.Models.MemberShip", b =>
                {
                    ...
                    b.HasOne("GymManagement.DAL.Plan", "Plan")
                        .WithMany("Members")
